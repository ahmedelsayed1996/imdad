<template>
  <div class="d-flex justify-content-end">
    <button type="button" class="btn btn-outline-dark   btn-sm p-2 m-2 ml-auto mr-5" id="add-btn">اضافة فرع جديد +</button>
  </div>
  <div class="card-body">

    <div class="col-3 ">
      <div class="card p-3 text-center btn-imdad text-light">
        <p class="m-0"> المبيعات </p>
        <p class="m-0"><b>5</b></p>
      </div>
    </div>
    <div class="col-3">
      <div class="card p-3 text-center btn-imdad text-light">
        <p class="m-0"> التقارير</p>
        <p class="m-0"><b>3400.20</b> </p>
      </div>
    </div>
    <div class="col-3">
      <div class="card p-3 text-center btn-imdad text-light">
        <p class="m-0"> الزيارات</p>
        <p class="m-0"><b>100.01</b> </p>
      </div>
    </div>
    <div class="col-3">
      <div class="card p-3 text-center btn-imdad text-light">
        <p class="m-0"> المحفظة</p>
        <p class="m-0"><b>100.01</b> </p>
      </div>
    </div>
  </div>
                ...
                <a href="#">
                    <div class="card card-image  ">
                        <div class="card-heading p-4">
                            ...
                            <div>
                                <h5 class="font-16"> اكثر المنتجات مبيعات </h5>
                            </div>
                            <h3 class="mt-4">108 طلب</h3>
                            <!-- <div class="progress mt-4" style="height: 4px;"> 
                             <div class="progress-bar bg-primary" role="progressbar" style="width: 75%" aria-valuenow="75"
