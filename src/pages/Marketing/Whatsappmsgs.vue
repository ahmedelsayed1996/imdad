<template>
    <div class="headLine fs-3 text-start p-2 pr-4">التسويق عبر رسائل الواتساب</div>
    <div class="d-flex justify-content-center align-items-center"
        style="height: 100vh; background: url('https://www.forecovery.com/wp-content/uploads/2018/06/whatsapp-share-contact.jpg');">
